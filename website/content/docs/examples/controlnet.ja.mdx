---
title: ControlNet (Vibe Transfer)
description: 参照画像から構図・ポーズ・雰囲気を転写する。
---

ControlNet (NovelAI の Vibe Transfer / Palette Transfer を含む) を使用すると、
参照画像から構図、ポーズ、または「雰囲気 (Vibe)」を転写できます。
