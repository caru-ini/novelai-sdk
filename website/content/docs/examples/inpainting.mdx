---
title: Inpainting
description: Regenerate a masked area of an image.
---
...
<Callout type="info">
The model is automatically switched to the inpainting variant (e.g., `nai-diffusion-4-5-full` → `nai-diffusion-4-5-full-inpainting`). You don't need to specify it manually.
</Callout>
